...
CREATE INDEX ai_prompt_versions_active_idx ON public.ai_prompt_versions(is_active) WHERE is_active = true;
...
CREATE INDEX ai_message_feedback_msg_idx ON public.ai_message_feedback(message_id);
